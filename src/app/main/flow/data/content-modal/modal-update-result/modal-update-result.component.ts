...
import {IActResult, IBodyResultReason} from '@app/types/flow';
import {AutoTaskService} from '@app/services/api/autoTask.service';
import {CommonService} from '@app/services/common/common.service';

@Component({
  selector: 'app-modal-update-result',
  templateUrl: './modal-update-result.component.html',
  styleUrls: ['./modal-update-result.component.scss'],
})
export class ModalUpdateResultComponent implements OnDestroy, OnInit {
  @Input() sourceData?: IActResult;
