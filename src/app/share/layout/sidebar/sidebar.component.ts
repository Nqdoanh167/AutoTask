  ...
  public sidebars: ISidebar[] = [
    {
      ...
      iconActive: 'fa-solid fa-list-check text-white',
      isActive: true,
    },
    {
      link: `/${EModule.LEAD}`,
      ...
      iconActive: 'fa-solid fa-filter text-white',
      isActive: false,
    },
    {
      link: `/${EModule.CONFIG}`,
      ...
      iconActive: 'fa-solid fa-diagram-predecessor text-white',
      isActive: false,
    },
    {
      ...
      iconActive: 'fa-solid fa-gear text-white',
      isActive: false,
    },
  ];
  public biz!: Biz;
