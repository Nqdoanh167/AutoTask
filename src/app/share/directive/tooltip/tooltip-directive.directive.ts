...
export class TooltipDirective {
  ...
  hide() {
    ...
    this.renderer.removeClass(this.tooltip, 'custom-tooltip');
    window.setTimeout(() => {
  ...
  create() {
    ...
    const text = this.renderer.createText('(Tính năng đang phát triển!)');
    ...
    if (this.isPending) {
      this.renderer.appendChild(warning, text);
      this.renderer.appendChild(this.tooltip, warning);
    }
